...
func authorizationRequest(value types.AuthorizeReq) domain.AuthorizationRequest {
	return domain.AuthorizationRequest{EnterpriseID: value.EnterpriseID, ApplicationInstanceID: value.ApplicationInstanceID, PrincipalID: value.PrincipalID, PrincipalKind: value.PrincipalKind, IdentityProvider: value.IdentityProvider, PolicySubject: value.PolicySubject, DirectGroupIDs: value.DirectGroupIDs, DirectGroupVersion: value.DirectGroupVersion, PolicyID: value.PolicyID, Action: value.Action, ResourceID: value.ResourceID, ResourceVersion: value.ResourceVersion}
}
