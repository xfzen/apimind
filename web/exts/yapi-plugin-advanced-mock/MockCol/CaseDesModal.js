...
import { Form, Select, InputNumber, Switch, Col, message, Row, Input, Button, AutoComplete, Modal } from 'antd';
...
class CaseDesForm extends Component {
  ...
  addValues = key => {
    ...
    let values = getFieldValue(key) || this.state[key] || [];
  ...
  render() {
        ...
        <div key={index} className="paramsArr" style={{ display }}>
          ...
          >
            <Row gutter={8}>
              <Col span={10}>
                <FormItem>
                  <FormItem name={['paramsArr', index, 'name']} initialValue={item.name} noStyle>
                    <AutoComplete
              ...
              <Col span={10}>
                <FormItem>
                  <FormItem name={['paramsArr', index, 'value']} initialValue={item.value} noStyle>
        ...
        <div key={index} className="headers">
          ...
          >
            <Row gutter={8}>
              <Col span={10}>
                <FormItem>
                  <FormItem name={['headers', index, 'name']} initialValue={item.name} noStyle>
                    <AutoComplete
                      options={dataSource.map(value => ({ value }))}
                      placeholder="参数名称"
                      filterOption={(inputValue, option) =>
              ...
              <Col span={10}>
                <FormItem>
                  <FormItem name={['headers', index, 'value']} initialValue={item.value} noStyle>
                    <Input placeholder="参数值" />
                  </FormItem>
                </FormItem>
              </Col>
    ...
    return (
      ...
      >
        <Form form={this.props.form} onFinish={this.handleOk} onValuesChange={() => this.forceUpdate()}>
