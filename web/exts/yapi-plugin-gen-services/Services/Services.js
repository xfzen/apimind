...
import { getBackendOrigin } from 'client/utils/backend';
...
export default class Services extends Component {
            ...
            <pre>{`
  {
    ...
    "remoteUrl": "${origin}/api/open/plugin/export-full?type=json&pid=${id}&status=all&token=${this.props.token}",
    "type": "yapi",
    "swaggerParser": {}
  }
  `}
  ...
  `}</pre>
            <pre>{`
  {
    "url": "${origin}/api/open/plugin/export-full?type=json&pid=${id}&status=all&token=${this.props.token}",
    "type": "yapi",
    "swaggerParser": {}
  }
  `}
