...
class UpDateModal extends Component {
  ...
  componentDidUpdate(prevProps) {
    const opened = this.props.isUpdateModalShow && !prevProps.isUpdateModalShow;
    const changedProject = this.props.handleUpdateIndex !== prevProps.handleUpdateIndex;
    if (this.props.isUpdateModalShow && (opened || changedProject)) {
      const project = this.props.projectList[this.props.handleUpdateIndex];
      this.props.form.setFieldsValue({
        envs: project && project.env ? project.env : []
      });
    }
  }
  ...
  handleOk = e => {
    ...
    form
      ...
      .then(values => {
        ...
        values.envs = form.getFieldValue('envs') || [];
  ...
  render() {
    ...
    const envs = getFieldValue('envs') || envMessage;
              ...
              rules={[
                {
                  ...
                  validator(rule, value) {
                    ...
                    if (/prd/.test(value)) {
                      return Promise.reject(new Error('环境域名不能是"prd"'));
                    }
...
function UpDateModalForm(props) {
  ...
  return <UpDateModal {...props} form={form} />;
}
