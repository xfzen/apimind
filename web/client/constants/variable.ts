...
export const IP_REGEXP = /^(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])(\.(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])){3}$/;
...
export const LAYOUT = {
  PAGE_GAP: 16,
  SIDE_WIDTH: 260,
  PROJECT_CONTENT_HEIGHT: 'calc(100vh - 122px)',
  GROUP_CONTENT_HEIGHT: 'calc(100vh - 80px)'
};
